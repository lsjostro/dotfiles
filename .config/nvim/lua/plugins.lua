return require('packer').startup(function()
    ...
    use {
        'hrsh7th/nvim-cmp',
        requires = {
            'andersevenrud/cmp-tmux', 'hrsh7th/cmp-nvim-lsp',
    ...
    use {
        "ray-x/go.nvim",
        config = function()
            require('go').setup({comment_placeholder = ''})
            vim.cmd(
                "autocmd FileType go nmap <Leader>c :lua require('go.comment').gen()<cr>")
            vim.cmd(
