...
local themeShelmanDark = {
    colors = {
        ...
        split = "#444444",
        ansi = {
            "#000000", "#ff605a", "#b1e869", "#ead89c", "#5da9f6", "#e86aff",
            "#82fff6", "#ded9ce"
        },
        brights = {
            "#313131", "#f58b7f", "#dcf88f", "#eee5b2", "#a5c7ff", "#ddaaff",
            "#b6fff9", "#fefffe"
        },
        tab_bar = {
            background = "#000000",
...
local themeShelmanLight = {
    colors = {
        ...
        selection_bg = "#FFCA28",
        ansi = {
            "#212121", "#b7141e", "#457b23", "#f5971d", "#134eb2", "#550087",
            "#0e707c", "#eeeeee"
        },
        brights = {
            "#424242", "#e83a3f", "#7aba39", "#fee92e", "#53a4f3", "#a94dbb",
            "#26bad1", "#d8d8d8"
        },
    ...
    tab_bar_style = {
        ...
        inactive_tab_left = wezterm.format({
            ...
            {Foreground = {Color = "#f7f7f7"}}, {Text = " "}
        }),
        inactive_tab_right = wezterm.format({
            {Background = {Color = "#778899"}},
            {Foreground = {Color = "#333333"}}, {Text = "▕"}
        }),
        inactive_tab_hover_left = wezterm.format({
            {Background = {Color = "#333333"}},
            {Foreground = {Color = "#ffffff"}}, {Text = " "}
    ...
    font_rules = {
        {
            ...
            font = font_with_fallback("Iosevka Term Curly Slab",
                                      {weight = "Regular", italic = true})
        }, {
            italic = true,
            intensity = "Bold",
            font = font_with_fallback("Iosevka Term Curly Slab",
                                      {weight = "Light", italic = true})
        }, {
            intensity = "Bold",
